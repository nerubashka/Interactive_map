...
import "./chunk-SHOJPROD.js";
import "./chunk-JEXJ2ODG.js";
import "./chunk-6PRKNV5P.js";
import {
  DEFAULT_TILE_SIZE
...
import "./chunk-OCK5CVCD.js";
import {
  DEFAULT_VERSION,
  ImageWMS_default,
  appendParams
} from "./chunk-ANFT3XHD.js";
import {
...
var mantissaBitLength = 10;
var mantissaMask = 1023;
var exponentMax = 31;
var exponentBias = 15;
...
function roundToFloat16Bits(num) {
  ...
  if (!NumberIsFinite(absolute)) {
    ...
    if (rawE + exponentBias >= exponentMax) {
      ...
      m = roundToEven((absolute * c - 1) * 1024);
      e = rawE + exponentBias;
    } else {
      m = roundToEven(absolute * 16777216);
      e = 0;
    }
  }
...
addDecoder(34887, () => import("./lerc-2CFGGLP6.js").then((m) => m.default));
