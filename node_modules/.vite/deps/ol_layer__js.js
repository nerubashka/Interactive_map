...
var MapRenderer = class extends Disposable_default {
  ...
  forEachFeatureAtCoordinate(coordinate, frameState, hitTolerance, checkWrapped, callback, thisArg, layerFilter, thisArg2) {
    let result;
    const viewState = frameState.viewState;
    function forEachFeatureAtCoordinate(managed, feature, layer, geometry2) {
      return callback.call(thisArg, feature, managed ? layer : null, geometry2);
    }
    const projection = viewState.projection;
...
function setFirstBackground(mapOrLayer, glStyle, options) {
  glStyle.layers.some(function(layer) {
    if (layer.type === "background") {
      ...
      if (mapOrLayer instanceof Map_default2 || mapOrLayer instanceof Group_default) {
